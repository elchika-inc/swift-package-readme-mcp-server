// Import base types from shared library
import type { 
...
// Tool Parameters - Use base types from shared library
export type GetPackageReadmeParams = BaseGetPackageReadmeParams;
export type GetPackageInfoParams = BaseGetPackageInfoParams;
export type SearchPackagesParams = BaseSearchPackagesParams;
